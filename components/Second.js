    ...
    return(
        <View style={styles.container}>
            <View style={styles.container1}>
                ...
                <Text style={styles.shop1}>Add To Chart</Text>
            ...
            <View>
           <Image style= {styles.image} source={require("../assets/2.png")}></Image>
            </View>

            <View >
                <TouchableOpacity  style={styles.next} onPress={()=>{props.navigation.navigate("Third")}}>
